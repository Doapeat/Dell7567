...
* 2.未使用ssdt-x.aml变频,已测试使用Clover仿冒MacBookPro14,3，完美变频。看见有人说MacBookPro14,3存在问题，让我换MacBookPro14,1，目前尚未发现问题，所以不换！  
...
* 2018.12.11
	...
	* 去掉了FakePCIID_Broadcom_WiFi.kext，没换网卡的用这个也没用！
	* 大家说的Clover界面卡的问题我试了5次，没复现卡的情况，具体问题还需自测，初步判断是因为用了太花哨的主题，占用资源过多导致。
